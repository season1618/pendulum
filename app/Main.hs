...
main = do
    ...
    simulate (InWindow "Harmonic Oscillator" (640, 480) (100, 100)) white 24 [150, 0] harmOscView (\_ -> solveHamil (harmOscModel (1, 1)) midpointImplicit)
    simulate window white 128 [-pi/3, 0] (pendulumView (150, 0)) (\_ -> solveHamil (pendulumModel 1 (150, 0)) midpointImplicit)
